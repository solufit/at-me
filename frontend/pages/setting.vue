		...
		<div class="mt-3">
			<div class="border rounded-lg p-2 my-6">
				...
				<div class="p-3">
					<div class="overflow-x-auto">
						<table class="hidden md:table items-center justify-center text-center">
							<thead>
								<tr>
									<th>アカウント</th>
									<th>プロバイダー</th>
								...
								<tr>
									<td>
										<div class="flex items-center gap-3">
											...
											<div>
												<div class="font-bold text-left">{{ user?.displayName }}</div>
												<div class="text-sm opacity-50">sasanqu_a</div>
											</div>
										</div>
									</td>
									<td class="flex items-center justify-center">
									...
									<th>
										<button class="btn btn-sm">連携する</button>
									</th>
								</tr>
							</tbody>
						</table>
						<div class="bloxk md:hidden">
							<div class="my-3 flex items-center gap-3">
								...
								<button class="btn btn-sm w-24" @click="signInWithGoogle()">連携中</button>
							</div>
							<div class="my-3 flex items-center gap-3">
								<svg viewBox="0 0 98 98" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4">
									<path
								...
								<button class="btn btn-sm w-24" @click="linkWithGithub()">連携する</button>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="border rounded-lg p-2 my-6 md:p-6">
				...
				<div class="w-full text-center">
					<button class="btn btn-primary w-full max-w-md">保存</button>
				</div>
			</div>
		</div>
	</div>
